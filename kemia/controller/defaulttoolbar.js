...
// goog.exportSymbol('kemia.controller.DefaultToolbar.makeToolbar',
// kemia.controller.DefaultToolbar.makeToolbar);

// Font menu creation.

///** @desc Font menu item caption for the default sans-serif font. */
//kemia.controller.DefaultToolbar.MSG_FONT_NORMAL = goog.getMsg('Normal');
//
///** @desc Font menu item caption for the default serif font. */
//kemia.controller.DefaultToolbar.MSG_FONT_NORMAL_SERIF = goog
//		.getMsg('Normal / serif');
...
// * @private
// */
//kemia.controller.DefaultToolbar.I18N_FONTS_ = {
//	'ja' : [ {
//		caption : '\uff2d\uff33 \uff30\u30b4\u30b7\u30c3\u30af',
...
// * @private
// */
//kemia.controller.DefaultToolbar.locale_ = 'en-us';
//
///**
...
// */
//kemia.controller.DefaultToolbar.setLocale = function(locale) {
//	kemia.controller.DefaultToolbar.locale_ = locale;
//};
//
///**
// * Initializes the given font menu button by adding default fonts to the menu.
// * If kemia.controller.DefaultToolbar.setLocale was called to specify a
...
// */
//kemia.controller.DefaultToolbar.addDefaultFonts = function(button) {
//	// Normalize locale to lowercase, with a hyphen (see bug 1036165).
//	var locale = kemia.controller.DefaultToolbar.locale_.replace(/_/, '-')
//			.toLowerCase();
//	// Add locale-specific default fonts, if any.
//	var fontlist = [];
//
//	if (locale in kemia.controller.DefaultToolbar.I18N_FONTS_) {
//		fontlist = kemia.controller.DefaultToolbar.I18N_FONTS_[locale];
//	}
//	if (fontlist.length) {
//		kemia.controller.ToolbarFactory.addFonts(button, fontlist);
//	}
//	// Add locale-independent default fonts.
//	kemia.controller.ToolbarFactory.addFonts(button,
//			kemia.controller.DefaultToolbar.FONTS_);
//};
//
//// Font size menu creation.
//
///** @desc Font size menu item caption for the 'Small' size. */
//kemia.controller.DefaultToolbar.MSG_FONT_SIZE_SMALL = goog.getMsg('Small');
//
///** @desc Font size menu item caption for the 'Normal' size. */
//kemia.controller.DefaultToolbar.MSG_FONT_SIZE_NORMAL = goog.getMsg('Normal');
//
///** @desc Font size menu item caption for the 'Large' size. */
//kemia.controller.DefaultToolbar.MSG_FONT_SIZE_LARGE = goog.getMsg('Large');
//
///** @desc Font size menu item caption for the 'Huge' size. */
//kemia.controller.DefaultToolbar.MSG_FONT_SIZE_HUGE = goog.getMsg('Huge');
//
///**
...
// * @private
// */
//kemia.controller.DefaultToolbar.FONT_SIZES_ = [ {
//	caption : kemia.controller.DefaultToolbar.MSG_FONT_SIZE_SMALL,
//	value : 1
//}, {
//	caption : kemia.controller.DefaultToolbar.MSG_FONT_SIZE_NORMAL,
//	value : 2
//}, {
//	caption : kemia.controller.DefaultToolbar.MSG_FONT_SIZE_LARGE,
//	value : 4
//}, {
//	caption : kemia.controller.DefaultToolbar.MSG_FONT_SIZE_HUGE,
//	value : 6
//} ];
//
///**
...
// */
//kemia.controller.DefaultToolbar.addDefaultFontSizes = function(button) {
//	kemia.controller.ToolbarFactory.addFontSizes(button,
//			kemia.controller.DefaultToolbar.FONT_SIZES_);
//};
//
...
//kemia.controller.DefaultToolbar.MSG_FORMAT_HEADING = goog.getMsg('Heading');
//
///** @desc Caption for "Subheading" block format option. */
//kemia.controller.DefaultToolbar.MSG_FORMAT_SUBHEADING = goog
//		.getMsg('Subheading');
//
///** @desc Caption for "Minor heading" block format option. */
//kemia.controller.DefaultToolbar.MSG_FORMAT_MINOR_HEADING = goog
//		.getMsg('Minor heading');
//
///** @desc Caption for "Normal" block format option. */
//kemia.controller.DefaultToolbar.MSG_FORMAT_NORMAL = goog.getMsg('Normal');
//
///**
...
// * @private
// */
//kemia.controller.DefaultToolbar.FORMAT_OPTIONS_ = [ {
//	caption : kemia.controller.DefaultToolbar.MSG_FORMAT_HEADING,
//	command : goog.dom.TagName.H2
//}, {
//	caption : kemia.controller.DefaultToolbar.MSG_FORMAT_SUBHEADING,
//	command : goog.dom.TagName.H3
//}, {
//	caption : kemia.controller.DefaultToolbar.MSG_FORMAT_MINOR_HEADING,
//	command : goog.dom.TagName.H4
//}, {
//	caption : kemia.controller.DefaultToolbar.MSG_FORMAT_NORMAL,
...
// */
//kemia.controller.DefaultToolbar.addDefaultFormatOptions = function(button) {
//	kemia.controller.ToolbarFactory.addFormatOptions(button,
//			kemia.controller.DefaultToolbar.FORMAT_OPTIONS_);
//};
