 ...
 * {@link jchemhub.controller.ReactionEditor} and a {@link goog.ui.Toolbar}.
 * 
 ...
 * {@link jchemhub.controller.ReactionEditor.Command}s, they will function as
...
jchemhub.controller.ToolbarController = function(editor, toolbar) {
	...
	this.handler_.listen(this.editor_,
			jchemhub.controller.ReactionEditor.EventType.COMMAND_VALUE_CHANGE,
 ...
 * {@link jchemhub.controller.Command} constant. Subclasses may override this
 ...
 * @protected
 */
jchemhub.controller.ToolbarController.prototype.getComponentId = function(
		command) {
...
/**
 * Returns the {@link jchemhub.controller.Command} constant that corresponds to
 ...
 * extend {@code jchemhub.controller.ToolbarController}.
 * 
 * @return {!jchemhub.controller.ReactionEditor} The editor managed by the
 *         toolbar.
 * @protected
 */
...
jchemhub.controller.ToolbarController.prototype.disposeInternal = function() {
	jchemhub.controller.ToolbarController.superClass_.disposeInternal
			.call(this);
	if (this.handler_) {
 ...
 */
jchemhub.controller.ToolbarController.prototype.updateToolbarFromState = function(
		state) {
