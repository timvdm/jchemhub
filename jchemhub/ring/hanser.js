 ...
 */
goog.provide('jchemhub.ring.Hanser');
 ...
 */
jchemhub.ring.Hanser.findRings = function(_molecule,maxLen){
 ...
 * @param {Object} atoms
 */
jchemhub.ring.Hanser.createRing = function(atoms,molecule){
